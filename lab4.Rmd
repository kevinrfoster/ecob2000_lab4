...
For this lab, we do some regression models to explain wages. We want to understand how important is a college degree (and what major). These sort of regressions are commonly called "Mincer" models after Jacob Mincer who developed them.

We'll use the ACS NY data so load that up to begin, *acs2017_ny_data.RData*.
